...
public class BlissBeamCannon extends AbstractColladaModel {
	
	private static final float DIAM = 0.5f;
	private static final float HEIGHT = .9f;
	
	public BlissBeamCannon(Main main, float x, float z) throws IOException {
		super(main, "BlissBeamCannon", true, x, z, DIAM);
		
		Node n = ModelLoaders.LoadColladaModel(main.getDisplay(), "./data/models/BlissBeamCannon/models/model.dae", "./data/textures/floor4.jpg", 0.07f);
